...
FirstSynch.controller("employeeeditprofiles" , function ($rootScope,$scope, $http, apiUrl,$timeout) {
      ...
      $scope.uploadFiles = function () {
          ...
          data.append("student", $rootScope.empl_id);
    ...
    $scope.hobbies_edit = function(){
        ...
        $http.get(apiUrl+"api/v1/employee/get_hobby_details/"+$rootScope.user_id+"/")
            .then(function successCallback(response){
                $scope.hobbiesform = response.data;
                $scope.hobbiesform.empl_id = $rootScope.empl_id;
    ...
    $scope.hobbiessubmit = function(){
        var hobbies_data = {
            ...
            student : $scope.hobbiesform.empl_id
        }
        //alert(JSON.stringify(hobbies_data));
        $http.post(apiUrl+"api/v1/employee/api/v1/hobbyinfo/",JSON.stringify(hobbies_data))
    ...
    //
    //     $http.get(apiUrl+"api/v1/employee/api/v1/studentcharacteristic/")
    //         .then(function successCallback(response){
    ...
    $scope.charactersubmit = function(){
        ...
        angular.forEach($scope.selectedCharacter, function (selected, characters) {
            if (selected) {
                $scope.selectchar.push({student:$rootScope.empl_id,character:characters});

            }
        });
        //alert(JSON.stringify($scope.selectchar));

        $http.post(apiUrl+"api/v1/employee/api/v1/studentcharacteristic/",JSON.stringify($scope.selectchar))
        .then(function (response) {
    ...
    $scope.skillpersonnaledit = function(){
        $http.get(apiUrl+"api/v1/employee/get_skillset_details/"+$rootScope.user_id+"/")
            .then(function successCallback(response){
                $scope.skillsetpersonnalform = response.data;
                $scope.skillsetpersonnalform.student = $rootScope.empl_id;
    ...
    $scope.workhistroyeedit = function(){
        $http.get(apiUrl+"api/v1/employee/get_experience_details/"+$rootScope.user_id+"/")
            .then(function successCallback(response){
                ...
                $scope.workhistroyform.user = $rootScope.empl_id;
            }, function errorCallback(response){
                console.log("Unable to perform get student profile details");
        });
    };
    ...
    $scope.projectsedit = function(){
        $http.get(apiUrl+"api/v1/employee/get_project_details/"+$rootScope.user_id+"/")
            .then(function successCallback(response){
                ...
                $scope.projectsform.user = $rootScope.empl_id;
            }, function errorCallback(response){
                console.log("Unable to perform get student profile details");
        });
    };
    $scope.projectsubmit = function(){
        ...
        $http.post(apiUrl+"api/v1/employee/api/v1/projectdetails/",JSON.stringify(projects_data))
        .then(function (response) {
            $scope.personnalskillmessage = 'Successfully updated';
    ...
    $scope.educationedit = function(){
        $http.get(apiUrl+"api/v1/employee/get_education_details/"+$rootScope.user_id+"/")
            .then(function successCallback(response){
                $scope.educationform = response.data;
                $scope.educationform.user = $rootScope.empl_id;
            }, function errorCallback(response){
                console.log("Unable to perform get student profile details");
        });
    };
    ...
    $scope.leadershipedit = function(){
        $http.get(apiUrl+"api/v1/employee/get_leadershiproles_details/"+$rootScope.user_id+"/")
            .then(function successCallback(response){
                ...
                $scope.leadershipform.student = $rootScope.empl_id;
            }, function errorCallback(response){
                console.log("Unable to perform get student profile details");
        });
    };
...
FirstSynch.controller("employeebasicprofileupload" , function ($rootScope, $scope, $http, apiUrl) {
    ...
    $http.get(apiUrl+"api/v1/employee/get_student_details/1/")
        .then(function successCallback(response){
            $rootScope.empl_id = response.data[0].id;
    ...
    $scope.basicprofilesubmit = function(){
      ...
      var data = {
        ...
        $http.patch(apiUrl+"api/v1/employee/api/v1/studentprofile/"+$scope.basicprofileform.id+"/",data)
        .then(function (response) {
